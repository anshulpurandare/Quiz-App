...
=======
    ...
    const renderContent = () => {
        switch (view) {
            ...
            case 'quiz': 
                return <InteractiveQuiz roomCode={roomCode} questionData={currentQuestion} onQuizSubmit={handleQuizSubmit} />;
            ...
            case 'live_leaderboard': 
                ...
                return <LiveLeaderboard leaderboardData={leaderboard} correctAnswer={correctAnswer} yourAnswer={myLastAnswer} />;
            case 'leaderboard': 
